...
\begin{enumerate}
\item When presented with identical comments, users of MindMargin will develop more thoughtful and nuanced opinions of an article than users of a traditional vertical interface. % because MindMargin encourages readers to consider alternate views by exposing them to a greater diversity and number of comments.  
