...
\def\plaintitle{MindMargin: Capturing Reader Engagement with an Article-Adjacent Commenting Platform}
\def\plainauthor{Daniel Haehn, Sharon Zhou, Krzysztof Gajos}
\def\plainkeywords{Comments; anchored; commenting systems; personal reflection.}
\def\plaingeneralterms{Comments, Personal Reflection}
